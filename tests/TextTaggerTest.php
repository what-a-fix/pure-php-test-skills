...
class TextTaggerTest extends TestCase
{
    ...
    public function testCaseAddTheme()
    {
        static::assertCount(1, $this->textTagger->getThemes());

        $this->textTagger->addTheme(new ThemeSim(Theme::createFromXML(__DIR__.'/assets/basic_theme.xml')));
        static::assertCount(1, $this->textTagger->getThemes());
        $this->textTagger->addTheme(new ThemeSim(Theme::createFromXML(__DIR__.'/assets/bathroom.xml')));
        static::assertCount(2, $this->textTagger->getThemes());
        $this->textTagger->addTheme(
            new ThemeSim(Theme::createFromXML(__DIR__.'/assets/basic_theme.xml')),
        ...
        static::assertCount(5, $this->textTagger->getThemes());
    }
}
